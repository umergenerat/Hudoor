...
const Settings: React.FC<SettingsProps> = ({ 
  ...
  const handleSaveProfile = () => {
    if (!currentUser || !onUpdateUsers) return;
    ...
    <div className="space-y-6 animate-fade-in pb-24 md:pb-8" dir={dir}>
      ...
      <div className="bg-white p-4 md:p-6 rounded-xl shadow border border-slate-200">
        ...
        <div className="flex justify-end pt-6 mt-4">
             <button onClick={handleSaveProfile} className="w-full md:w-auto bg-sky-600 hover:bg-sky-700 text-white px-8 py-3 rounded-lg flex items-center justify-center gap-2 transition-all shadow-md font-bold text-sm active:scale-95">
                 <Save size={18} />
